...
a connection to one or more  DatariumDB federation nodes.

"""
import logging
from functools import singledispatch

from datariumdb.common.transaction import (
    Input,
    Transaction,
    TransactionLink,
...
from .exceptions import DatariumdbException, MissingPrivateKeyError
from .utils import (
    CreateOperation,
    TransferOperation,
...
def prepare_create_transaction(*,
    ...
    # https://github.com/datariumdb/datariumdb/issues/797
...
def prepare_transfer_transaction(*,
    ...
    Example:
        ...
        ``tx``::
            ...
            # noqa E501
            >>> tx
                {'asset': {'data': {'msg': 'Hello DatariumDB!'}},
